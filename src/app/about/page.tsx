      ...
      <section className="bg-[#0B1F3B] text-white py-16 mb-2">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-primary rounded-lg p-8 text-white">
              <h3 className="font-heading text-4xl font-semibold mb-4 text-[#C6A75E]">Our Mission</h3>
              <p className="mb-4 text-2xl">
                To provide practical, performance-based Virtual Assistant training rooted in professionalism and accountability.
              </p>
              <h3 className="font-heading text-4xl md:text-2xl font-semibold mb-4 text-[#C6A75E]">Our Values</h3>
              <ul className="space-y-2 text-xl md:text-xl">
                <li>• Discipline</li>
                <li>• Excellence</li>
                <li>• Integrity and Practicality</li>
