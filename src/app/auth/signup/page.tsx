...
// }
  ...
  if (success) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#0B1F3B] py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-md w-full space-y-8 bg-gray-800 p-8 rounded-xl shadow-lg border border-gray-700 text-center">
          ...
          <p className="mt-2 text-sm text-gray-300">
            A confirmation email has been sent to <span className="font-semibold text-blue-400">{formData.email}</span>. 
