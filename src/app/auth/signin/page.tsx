...
//     else router.push('/') // will redirect to dashboard via landing page
//   }

//   return (
//     <form onSubmit={handleSignIn} className="max-w-md mx-auto mt-20 p-6 border rounded">
...
export default function SignIn() {
  ...
  const handleSignIn = async (e: React.FormEvent) => {
    ...
    if (profileError || !profile) {
      // If no profile exists (unlikely), create one with default role 'student'
          ...
          <div className="rounded-md shadow-sm -space-y-px">
            <div>
              ...
              <input
                ...
                value={email}
                onChange={(e) => setEmail(e.target.value)}
                className="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-white rounded-t-md focus:outline-none focus:ring-primary-500 focus:border-primary-500 focus:z-10 sm:text-sm"
